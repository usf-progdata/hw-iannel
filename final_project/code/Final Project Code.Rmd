...
data_clean_NonClinical <- data_clean %>% 
                          select(Sample == !Clinical)

CF_Model_Fit <- cfa(CF_Model, data = data_clean, estimator = "ML", missing = "fiml", std.lv= TRUE)
...
write_csv(
  data_clean,
  here::here("data", "data_clean", "DT-Res_synthetic_clean")
)
