...
Usually, I prefer to make my function names *verbs* to make it clear that they *do* something (e.g., make_descriptives_table).

Then, tell R that you are making a function by assigning `function() {}` to your
function name:

```{r, eval = FALSE}
function_name <- function() {} #e.g., function(.data, variables, ) {}
```
