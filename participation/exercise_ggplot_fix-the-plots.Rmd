...
Fix the overlapping data points problem in the following plot using each of these solutions: #do each one of these individually 
...
ggplot(gapminder) +
  ...
  scale_x_log10(label = comma) #check to see if this is accurate
```
